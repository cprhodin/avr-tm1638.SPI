...
/* Arduino signals */
#define PIN_A0         (16+PORTC0)
#define PINMAP_A0      _BVl(PIN_A0)
#define PIN_A1         (16+PORTC1)
#define PINMAP_A1      _BVl(PIN_A1)
#define PIN_A2         (16+PORTC2)
#define PINMAP_A2      _BVl(PIN_A2)
#define PIN_A3         (16+PORTC3)
#define PINMAP_A3      _BVl(PIN_A3)
#define PIN_A4         (16+PORTC4)
#define PINMAP_A4      _BVl(PIN_A4)
#define PIN_A5         (16+PORTC5)
#define PINMAP_A5      _BVl(PIN_A5)
...
#define PIN_D8         (8+PORTB0)
#define PINMAP_D8      _BVl(PIN_D8)
#define PIN_D9         (8+PORTB1)
#define PINMAP_D9      _BVl(PIN_D9)
#define PIN_D10        (8+PORTB2)
#define PINMAP_D10     _BVl(PIN_D10)
#define PIN_D11        (8+PORTB3)
#define PINMAP_D11     _BVl(PIN_D11)
#define PIN_D12        (8+PORTB4)
#define PINMAP_D12     _BVl(PIN_D12)
#define PIN_D13        (8+PORTB5)
#define PINMAP_D13     _BVl(PIN_D13)
...
static __inline uint8_t pin_test(pin_t pin)
{
    uint8_t bit = 0;

         if (pin >= 24) bit = bit_test(&PORTD, pin - 24);
    else if (pin >= 16) bit = bit_test(&PORTC, pin - 16);
    else if (pin >=  8) bit = bit_test(&PORTB, pin -  8);
...
static __inline uint8_t pinmap_test(pinmap_t pinmap)
{
    uint8_t bit = 0;

    if (pinmap & (0xffUL << 24)) bit |= bitmask_test(&PIND, pinmap >> 24);
    if (pinmap & (0xffUL << 16)) bit |= bitmask_test(&PINC, pinmap >> 16);
    if (pinmap & (0xffUL <<  8)) bit |= bitmask_test(&PINB, pinmap >>  8);
